...
-- Records of fa_admin
-- ----------------------------
INSERT INTO `__PREFIX__admin` VALUES ('1', 'admin', 'Admin', '075eaec83636846f51c152f29b98a2fd', 's4f3', '/assets/img/avatar.png', 'admin@fladmin.net', '0', '1568974340', '127.0.0.1', '1492186163', '1568974340', '4520a15d-963b-4cdc-a012-eb3a5e2d9cec', 'normal');
...
-- ----------------------------
INSERT INTO `__PREFIX__config` VALUES ('1', 'name', 'basic', 'Site name', '请填写站点名称', 'string', 'fladmin-TP6', '', 'required', '', '');
...
CREATE TABLE `__PREFIX__user` (
  ...
  `prev_time` int(10) NOT NULL COMMENT '上次登录时间',
