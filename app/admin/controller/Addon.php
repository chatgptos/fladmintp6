...
class Addon extends Backend
{
    ...
    public function index()
    {
        ...
        $this->assignconfig(['addons' => $addons, 'api_url' => config('fladmin.api_url'), 'faversion' => config('fladmin.version')]);
    ...
    public function downloaded()
    {
        ...
        if (!is_array($onlineaddons) && config('fladmin.api_url')) {
            $onlineaddons = [];
            $result = Http::sendRequest(config('fladmin.api_url') . '/addon/index', [], 'GET', [
