    ...
    var Controller = {
        index: function () {
                    ...
                    success: function (ret) {
                        require(['template'], function (Template) {
                            var install = function (name, title) {
                                Fast.api.ajax({
                                    url: 'addon/install',
                                    data: {name: name, faversion: Config.fladmin.version}
                                }, function (data, ret) {
            ...
            var checkupdate = function (ignoreversion, tips) {
                $.ajax({
                    url: Config.fladmin.api_url + '/version/check',
                    type: 'post',
                    data: {version: Config.fladmin.version},
                    dataType: 'jsonp',
                    success: function (ret) {
            ...
            if (Config.fladmin.checkupdate && ignoreversion !== "*") {
            ...
            var multiplenav = Config.fladmin.multiplenav;
